...
<div class="bg-white w-full">
    <div class="container mx-auto pt-12 px-8">
        ...
        <h1 class="text-3xl font-bold text-black mt-10 mb-5 text-balance">Design UI/UX GoTrans</h1>
    </div>
    <div class="container mx-auto pb-12 px-8 flex flex-col md:flex-row items-start justify-between gap-14">
        ...
        <div class="w-full md:w-1/2">
            ...
            <span class="inline-flex items-center rounded-md bg-[#EEEEEE] px-2 mr-2 mb-2 py-1 text-sm font-semibold text-[#CB0001] ring-2 ring-inset ring-gray-500/10">Figma</span>

            <div class="flex flex-row items-center pb-12 space-x-2 mt-3">
                <a href="https://www.figma.com/proto/U541xvZ00HgNMNsKEERWAX/Tubes-UI%2FUX-Go-Trans?node-id=284-6830&node-type=canvas&t=nbd6iLIuoYgTEUEs-1&scaling=min-zoom&content-scaling=fixed&page-id=18%3A2&starting-point-node-id=367%3A25817&show-proto-sidebar=1" class="text-[#EEEEEE] bg-[#CB0001] rounded-full font-bold text-base px-8 py-1 hover:bg-[#EEEEEE] hover:text-[#CB0001]">
                    See Prototype
                </a>
            </div>
        </div>
